...
//   { value: 'tashkent',          label: '🏙️ Tashkent Block',           max: 5 },
//   { value: 'tiif-2026',         label: '🎪 TIIF-2026 Block',          max: 5 },
// ];
...
//     onSave({ ...f, hashtags: normalizeHashtags(hashTxt), blocks: blocksJson }, file, blockFiles);
//   };
...
/* Section value -> human label, for the duplicate-title warning banner */
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        // Ignore stale responses if the title changed again while this was in flight
