  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/85">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-1.5 sm:px-5 lg:px-6 xl:px-8">
          <div className="flex-shrink-0">
            {/* FIXED: was a plain <a href="/">, which forces a full browser
                reload (and wipes the HomePage in-memory cache) every time
                someone clicks the logo. <Link> does client-side routing
                instead, matching every other nav item in this file. */}
            <Link to="/" className="flex items-center pl-2 sm:pl-3 lg:pl-4">
              <div className="w-[220px] sm:w-[260px] lg:w-[300px]">
                <img
                  src={logo1}
                  alt="EM Insights"
                  className="block h-auto max-h-12 w-full object-contain object-left sm:max-h-14 lg:max-h-16"
                />
              </div>
            </Link>
          </div>
        ...
        >
          <nav className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-6 py-2 xl:px-8">
              ...
              <div className="flex h-full flex-col">
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-5">
                  <div className="min-w-0 flex-1 lg:flex-none">
                    {/* FIXED: same plain <a> issue as the main logo above */}
